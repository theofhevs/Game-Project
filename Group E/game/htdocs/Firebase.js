...
topTenUsers.forEach((user, index) => {
  ...
  if (user.playerName.length > 25) truncatedName += "...";

  row.innerHTML = `
    <td style="color: white; font-weight: bold; background: transparent;">${index + 1}</td>
    <td style="color: white; font-weight: bold; background: transparent;">${truncatedName}</td>
    <td style="color: white; font-weight: bold; background: transparent;">${user.score}</td>
  `;
